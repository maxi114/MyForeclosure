...
import { ThemeSettings, useThemeContext } from '@/app/context/ThemeContext';
import { findAllParent, findMenuItem } from '@/utils/menu';

function MenuItemWithChildren({ item, linkClassName, subMenuClassNames, activeMenuItems, toggleMenu }) {
  ...
  return (
    <ul className="side-nav" ref={menuRef} id="main-side-menu">
      ...
      <div className="help-box text-white text-center">
        <Link href="" className="float-end close-btn text-white">
          <i className="mdi mdi-close" />
        </Link>
        <Image src={helpBoxImage} height={90} width={90} alt="Helper Icon Image" />
